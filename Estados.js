...
ajustarTamanoYCambiarCoordenadas() {
  if (this.achicar) {
    if (this.factorTam > 10) {
      // Reducir el tamaño
      this.factorTam -= 10;
    } else {
      // Cambiar coordenadas cuando el tamaño mínimo se alcanza
      this.cambiarCoordenadas();
      // Restablecer la bandera para agrandar
      this.achicar = false;
      this.agrandar = true;
    }
  } else if (this.agrandar) {
    if (this.factorTam < 50) {
      // Aumentar el tamaño de vuelta al original
      this.factorTam += 10;
    } else {
      // Restablecer la bandera para el próximo ciclo de achicar
      this.achicar = true;
      this.agrandar = false;
    }
  }
...
//cambiarTam() { // cambio de tamaño 
    
//    if (keyIsPressed) {
//       if (key === 'z'){
//       if (this.achicar == true &&  this.factorTam >= 10){
//       this.factorTam--;
//       }
//       }
       
//       if (key === 'x'){
//       if (this.agrandar == true && this.factorTam <= 50) {
//          this.factorTam++;
//       }
//       }
//    }
